...
- Bump `versionName` with the same intent, for example `1.9.3-universal-carrier`.
...
The helper writes `dist/windows/XLTD_Vpn-Windows-0.5.3-beta-win-x64.zip` and prints SHA256 for the GitHub pre-release.
...
5. Upload Android APKs to stable Android tags such as `v1.9.3`.
6. Upload Windows beta zips to pre-release Windows tags such as `windows-v0.5.3-beta`.
